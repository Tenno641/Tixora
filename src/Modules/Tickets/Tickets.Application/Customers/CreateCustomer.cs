...
internal sealed class CreateCustomer : IRequestHandler<CreateCustomerCommand, ErrorOr<Guid>>
{
    private readonly ICustomerRepository _customerRepository;
    private readonly IUnitOfWork _unitOfWork;
    
    public CreateCustomer(ICustomerRepository customerRepository, IUnitOfWork unitOfWork)
    {
