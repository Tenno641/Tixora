...
public class CartService: ICartService
{
    ...
    {
        Cart? cart = await _cache.GetAsync<Cart>(GenerateCacheKey(customerId), cancellationToken);
    ...
    public async Task InsertCartItemAsync(Guid customerId, CartItem cartItem, TimeSpan? expiration, CancellationToken cancellationToken = default)
    {
        ...
        await _cache.SetAsync(cacheKey, existingCartItems, _defaultExpiration, cancellationToken);
    }
